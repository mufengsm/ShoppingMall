...
// 搜索页面产品信息
export const POST_BRAND_LIBRARY_QUERY = networkApi+'/v4/goods/goods_list';
// 控区控价信息列表
export const POST_BRAND_LIST = formalNetworkApi+'/v4/Brands/index';
// 查询品牌
export const POST_QUERY_BRAND = networkApi+'/v4/goods/brand_list';
// 查询分类
export const POST_QUERY_CLASSIFICATION = networkApi+'/v4/goods/cate_list';